      ...
      <header className="h-16 w-full flex justify-between items-center top-0 left-0 bg-edDarker text-edWhite font-semibold border-b border-edDarkGray">
        <div className="w-screen flex flex-row justify-between">
          <div className="flex items-center justify-start mr-auto ml-10">
            <Link onClick={(e) => navigateWithRefresh(e, "/")} className="flex items-center">
          ...
          <div className="flex items-center space-x-4 justify-end mr-10">
            <Link onClick={(e) => navigateWithRefresh(e, "/login")} className="px-4 py-2 hover:text-edBlue border-2 border-transparent hover:border-edBlue active:scale-[95%]">Log in</Link>
            <Link onClick={(e) => navigateWithRefresh(e, "/signup")} className="px-4 py-2 bg-edBlue text-edWhite border-2 border-transparent hover:border-edWhite active:scale-[95%]">Sign up</Link>
          </div>
        </div>
      </header>
    );
      ...
      <header className="h-16 flex justify-center top-0 left-0 w-full text-lg bg-elLightBlue border-elLightBlue dark:bg-edDarker font-semibold border-b dark:border-edDividerGray">
        <div className="w-screen flex flex-row justify-around text-white">
          ...
          <div className="flex ml-auto items-center">
            <Link onClick={(e) => navigateWithRefresh(e, "/leaderboard")} className="px-4 mx-2 transition duration-100 hover:text-black dark:hover:text-elLightBlue py-2">Leaderboard</Link>
            <Link onClick={(e) => navigateWithRefresh(e, "/cards")} className="px-4 mx-2 transition duration-100 hover:text-black dark:hover:text-elLightBlue py-2">Create Card</Link>
            <Link onClick={(e) => navigateWithRefresh(e, "/help")} className="px-4 mx-2 transition duration-100 hover:text-black dark:hover:text-elLightBlue py-2">Help</Link>
            <Link onClick={(e) => navigateWithRefresh(e, "/community")} className="px-4 ml-2 transition duration-100 hover:text-black dark:hover:text-elLightBlue py-2">Community</Link>
            <Link onClick={(e) => navigateWithRefresh(e, "/myimages")} className="px-4 ml-2 transition duration-100 hover:text-black dark:hover:text-elLightBlue py-2">My Images</Link>
