...
function Header() {
  ...
  if (isGuestPage) {
    return (
      <header className="h-16 w-full flex justify-between items-center top-0 left-0 bg-eDarker text-eWhite font-semibold border-b border-eDarkGray">
    ...
    return (
      <header className="h-16 flex justify-center top-0 left-0 w-full bg-eDarker font-semibold border-b border-eDarkGray">
