  ...
  return (
    <>
      <div className="flex justify-between w-full">
        ...
        <img src="../Study.png" alt="Study PNG" className="w-1/3"></img>
      </div>
      <div className="flex justify-between w-full">
        <div className="flex flex-col items-center flex-grow">
          <img src="../growth.png" alt="growth PNG" className="w-1/3 mt-2"></img>
        ...
        <div className="flex flex-col items-center flex-grow">
          <img src="../idea.png" alt="idea PNG" className="w-1/3 mt-2"></img>
        ...
        <div className="flex flex-col items-center flex-grow">
          <img src="../user.png" alt="user PNG" className="w-1/3 mt-2"></img>
