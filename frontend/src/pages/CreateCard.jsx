  ...
  return (
    <>
      ...
      <div className="w-1/2 flex flex-col">
        <h1 className="text-2xl mb-4 mt-10 font-medium">New Card</h1>
        ...
        <div className="border border-eMedGray">
...
function TextBox({ label, content, inputHandler }) {
  ...
  return (
    <>
      ...
      {textBoxOpen && (
        <textarea value={content} onInput={inputHandler} className="bg-eDarker w-full h-20 p-2 border border-eDarkGray focus:outline-none"></textarea>
      )}
    </>
  );
}
...
function TextBoxPreview({ label, content }) {
  return (
    <>
      <div className="text-center bg-[#0f0f0f] w-full h-8 p-1 border border-eGray">{label}</div>
