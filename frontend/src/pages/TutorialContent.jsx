    ...
    case "Deck Page":
      return (
        <div className="text-white">
          ...
          <p className="text-lg mt-4">You can also click the <Focus text="Quiz" /> button to test yourself. The <Focus text="Statistics" /> button will navigate you to a page showing deck statistics, where you can view the number of upcoming/previous reviews and your correct review rate.</p>
          <p className="text-lg mt-4">The <Focus text="Edit All" /> button will take you to an edit page where you can update all the cards in the deck at once. Alternatively, you can click the edit icon on each card to edit them individually.</p>
          <p className="text-lg mt-4">The <Focus text="Public/Private" /> setting indicates whether your deck is public (available to the community) or private.</p>
          <p className="text-lg mt-4">The bar graph displays the percentage of cards you are caught up on.</p>
          <p className="text-lg mt-4">You can toggle deletion mode with the <Focus text="Toggle Delete Card" /> button and click on cards to delete them.</p>
          <p className="text-lg mt-4">You can create cards by going either to the <Focus text="Quick Create Card" /> button to create inline, or the <Focus text="Create Card" /> button to go to the card editor.</p>
          <p className="text-lg mt-4">If your deck is public, people can give it a rating (or favorite it).</p>
        </div>
      );
    case "Home Page":
      return (
    ...
    case "Sidebar":
      return (
        <div className="text-white">
          ...
          <p className="text-lg mt-2">
            An "Expand and Collapse" button is available at the top (it's the vertical arrow), allowing you to expand all your folders with one click and collapse them with another.
...
function Focus({ text }) {
  return (
    <span className="border py-0.5 px-1 rounded">{text}</span>
  )
}
