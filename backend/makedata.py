...
def initial_data():
    ...
    Card.objects.create(deck=us_pres_deck, question="2nd president", answer="John Adams", bucket=3, correct_count=3, incorrect_count=1)
    Card.objects.create(deck=us_pres_deck, question="3rd president", answer="Thomas Jefferson", bucket=3, correct_count=2, incorrect_count=1)
    Card.objects.create(deck=us_pres_deck, question="4th president", answer="James Madison", bucket=3, correct_count=2, incorrect_count=2)
    Card.objects.create(deck=us_pres_deck, question="5th president", answer="James Monroe", bucket=2, correct_count=3, incorrect_count=1)
    ...
    Card.objects.create(deck=us_pres_deck, question="11th president", answer="James K. Polk", bucket=0, correct_count=1, incorrect_count=2)
