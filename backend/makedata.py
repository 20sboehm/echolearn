...
def initial_data():
    ...
    # Create cards
    Card.objects.create(deck=us_pres_deck, question="1st president", answer="George Washington", bucket=5, correct_count=5, incorrect_count=0)
    Card.objects.create(deck=us_pres_deck, question="2nd president", answer="John Adams", bucket=4, correct_count=3, incorrect_count=0)
    Card.objects.create(deck=us_pres_deck, question="3rd president", answer="Thomas Jefferson", bucket=4, correct_count=2, incorrect_count=1)
    Card.objects.create(deck=us_pres_deck, question="4th president", answer="James Madison", bucket=3, correct_count=2, incorrect_count=1)
    Card.objects.create(deck=us_pres_deck, question="5th president", answer="James Monroe", bucket=3, correct_count=3, incorrect_count=1)
    Card.objects.create(deck=us_pres_deck, question="6th president", answer="John Quincy Adams", bucket=2, correct_count=2, incorrect_count=1)
    Card.objects.create(deck=us_pres_deck, question="7th president", answer="Andrew Jackson", bucket=2, correct_count=2, incorrect_count=0)
    Card.objects.create(deck=us_pres_deck, question="8th president", answer="Martin Van Buren", bucket=1, correct_count=2, incorrect_count=1)
    Card.objects.create(deck=us_pres_deck, question="9th president", answer="William Henry Harrison", bucket=1, correct_count=1, incorrect_count=0)
    Card.objects.create(deck=us_pres_deck, question="10th president", answer="John Tyler", bucket=1, correct_count=1, incorrect_count=0)
    Card.objects.create(deck=us_pres_deck, question="11th president", answer="James K. Polk", bucket=0, correct_count=2, incorrect_count=0)
